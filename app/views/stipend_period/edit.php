...
<div class="container mt-4">
    <div class="card shadow">
        ...
        <div class="card-header bg-warning text-dark">
            Rediģēt stipendijas periodu
        </div>

        <div class="card-body">

            <form method="POST" action="/period/edit?id=<?= $period['id'] ?>">
                ...
                <div class="mb-3">
                    ...
                    <input
                        type="number"
                        name="year"
                        value="<?= htmlspecialchars($period['year']) ?>"
                ...
                <div class="mb-3">
                    ...
                    <input
                        type="text"
                        name="period"
                        value="<?= htmlspecialchars($period['period']) ?>"
                ...
                <div class="mb-3">
                    ...
                    <input
                        type="text"
                        name="period_group"
                        value="<?= htmlspecialchars($period['period_group']) ?>"
